...
export class AudioEngine {
 constructor(){this.active=false;this.history=[];this.pitchHistory=[];this.kind='';this.micGeneration=0;this.fileGeneration=0;this.speechEnabled=true;this.onSpeech=null;this.offset=0;this.volume=0.8;this.duration=0;}
 async init(){
